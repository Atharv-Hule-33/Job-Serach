...
const About = () => {
  return (
    ...
    <div className='about-info'>
      <p>Our job finder website is designed to help job seekers find their dream job with ease. With a simple search box where you can enter your skills and desired location, our website fetches job listings from Rapid API (JSearch API) and presents them to you. We understand the importance of finding the right job, and that's why we make it easy for you to filter and sort through the job listings to find the one that fits your requirements.</p>
      <p>We are constantly working to improve our website, and we value your feedback. Our contact page features a form where you can provide us with suggestions on how we can improve our website to better serve you. </p>
      
      <NavLink to="/contact">
        <button>Contact Us</button>
      </NavLink>
      
      <p>Thank you for using our website, and we hope to help you find your dream job soon.</p>  
    </div>
